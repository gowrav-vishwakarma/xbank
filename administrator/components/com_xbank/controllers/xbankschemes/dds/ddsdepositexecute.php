...
if($ac->branch->id != Branch::getCurrentBranch()->id){
    ...
    Transaction::doTransaction($debitAccount, $creditAccount, (inp("Narration") ? inp("Narration") : "DDS Amount Deposit in $ac->AccountNumber"), TRA_DDS_ACCOUNT_AMOUNT_DEPOSIT, $voucherNo, $transactiondate);
    ...
    Transaction::doTransaction($debitAccount, $creditAccount, (inp("Narration") ? inp("Narration") : "DDS Amount Deposit in $ac->AccountNumber"), TRA_DDS_ACCOUNT_AMOUNT_DEPOSIT, Transaction::getNewVoucherNumber($ac->branch->id), $transactiondate,$ac->branch->id);
}
else {
    $debitAccount = array(
        $debitToAccount => inp("Amount"),
