...
$this->form->open("1", 'index.php?option=com_xbank&task=schemes_cont.newscheme')
                ...
                ->select("Flat/Reducing Rate","name='ReducingOrFlatRate' class='input'",array("FLAT" => FLAT_RATE, "REDUCING" => REDUCING_RATE))
//                ->select("Interest Rate Mode", "name='InterestRateMode' class='not-req tooltip' title='Select the mode of paying Premium' not-req-val='-1'", array('Select' => '-1', "Reducing" => "Reducing", "Flat" => "Flat"))
...
//                ->text("Depriciation % After September", "name='DepriciationPercentAfterSep' class='input'")
                ...
                ->submit("Create");
$this->jq->addTab(1, "Loan Schemes", $this->form->get());
