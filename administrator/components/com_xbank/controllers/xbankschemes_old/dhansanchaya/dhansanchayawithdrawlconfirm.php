...
$err = false;
$msg = "";
echo "<h2>Your Current Balance is : " . $balance . "<br>Are you sure you want to withdraw Rs. ".inp("Amount")." from $ac->AccountNumber?</h2><br/>Specimen Signature <img src='./signatures/sig_$ac->member_id.JPG' height='100' width='160'>";
if (($balance - $ac->Schemes->MinLimit) < inp("Amount")) {
    $err = true;
    $msg .="<br>Insufficient Balance [$balance]";
}
?>
