...
//        $totals +=$total->CurrentInterest;
    ...
    Transaction::doTransaction($debitAccount, $creditAccount, "Yearly Interst posting to Fixed Accounts", TRA_INTEREST_POSTING_IN_FIXED_ACCOUNT, Transaction::getNewVoucherNumber(), date("Y-m-d", strtotime(date("Y-m-d", strtotime(getNow("Y-m-d"))) . " +0 day")));
