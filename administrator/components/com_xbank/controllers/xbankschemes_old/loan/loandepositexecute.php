...
Transaction::doTransaction($debitAccount, $creditAccount, "Amount submitted in Loan Account $ac->AccountNumber", TRA_LOAN_ACCOUNT_AMOUNT_DEPOSIT, $voucherNo,$transactiondate);
