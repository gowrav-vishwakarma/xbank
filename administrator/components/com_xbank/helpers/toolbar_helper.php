...
class xDeveloperToolBars extends JObject {
    ...
    function getDefaultToolBar() {
        ...
        if ($b->result_count() == 0) {
            ...
            JToolBarHelper::custom('report_cont.new_reports','loan','loan', 'Loan Reports',false,false);
    ...
    function getReportManagementToolBar() {
        ...
        JToolBarHelper::addNewX('report_2_cont.duesToGiveForm', 'Dues To give <br/>Report');
