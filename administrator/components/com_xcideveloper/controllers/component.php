...
//        JFile::write($tmpComp.DS."manifest.xml",$prj->manifest);
    ...
    function manage(){
        ...
        $installsql=JFile::read(JPATH_ADMINISTRATOR. "\\components\\com_$r->component\\install.sql");
        ...
        $uninstallsql=JFile::read(JPATH_ADMINISTRATOR. "\\components\\com_$r->component\\uninstall.sql");
        ...
        $configFile=JFile::read(JPATH_ADMINISTRATOR. "\\components\\com_$r->component\\config.xml");
    ...
    function saveinstallscript(){
        ...
        $sql=str_replace("\n\n", "\n", $sql);
        JFile::write(JPATH_ADMINISTRATOR. "\\components\\com_$r->component\\install.sql",$sql);
    ...
    function saveuninstallscript(){
        ...
        $sql=$this->input->post("sql");
        $sql=str_replace("\n\n", "\n", $sql);
        JFile::write(JPATH_ADMINISTRATOR. "\\components\\com_$r->component\\uninstall.sql",$sql);
    ...
    function saveconfig(){
        ...
        JFile::write(JPATH_ADMINISTRATOR. "\\components\\com_$r->component\\config.xml",$xml);
